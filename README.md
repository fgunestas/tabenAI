...
<p align="center"> <img src="https://img.shields.io/badge/FastAPI-0.100.x-009688?logo=fastapi"> <img src="https://img.shields.io/badge/LangChain-MapReduce-blue?logo=python"> <img src="https://img.shields.io/badge/LLM-Gemini%20Flash-orange?logo=google"> <img src="https://img.shields.io/badge/Vector%20DB-ChromaDB-blueviolet"> <img src="https://img.shields.io/badge/Embeddings-BAAI%20BGE--M3-red"> <img src="https://img.shields.io/badge/API%20Docs-SwaggerUI-green?logo=swagger"> </p>

## 🚀 Features

⚡ **Next-Gen LLM Power:** Utilizes Google's `gemini-2.5-flash` model for blazing-fast inference speeds and huge context windows, eliminating the need for heavy local GPU memory for generation.

💎 **State-of-the-Art Embeddings:** Powered by **`BAAI/bge-m3`**, the current SOTA in multilingual embeddings. Supports lengthy contexts (up to 8192 tokens), dense/sparse retrieval capabilities, and superior accuracy in Turkish queries.
...
### 1️⃣ Requirements
    ...
    CUDA Toolkit *Optional for GPU accelaration for embeddings.
...
Run the API server directly with the python command.
```bash
python server.py
```
